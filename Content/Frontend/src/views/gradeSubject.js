...
export const expnadedCardJson = {
  ...
  detailedExplanation: [{ icons: 'SlBadge', text: 'New Authenticate Way to learn' }, { icons: 'PiStudent', text: '459,121 students enrolled' }],
  createdBy: 'Qvolv PVT LTD.',
  otherContentInHeader: [
    { icons: 'MdTipsAndUpdates', text: 'Last Updated 07/2024' },
  ...
  thismodulesIncludes: [
    { icons: 'FaPlay', text: '16 hours on-demand video' },
    { icons: 'PiInfinityBold', text: 'Full lifetime access' },
    { icons: 'IoDocumentOutline', text: '9 articles' }, 
...
const whatuLearnK12 = [
  ...
  {
    topic_name: "Electric Conductors Conductors and Insulators",
    whatWillULearn: [
